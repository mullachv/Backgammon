describe("Backgammon", function() {
  ...
  function testGetPossibleMoves(board, rollArray, player){
        return _gameLogic.getPossibleMoves(board, rollArray, player);
  }

    it("test number of elements in get possible moves" , function(){
        board = _gameLogic.getInitialBoard();
        rollarray = [4,4,4,4];
        player = 'W';
        possibleMoves = testGetPossibleMoves(board, rollarray, player);
...
//    });
//
//    it("expect the number of moves taken to be 2 or 4 depending on if doubles were rolled", function(){
//        expectIllegalMove(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//    });
//
//    it("trying to exit but no moves left", function(){
//        expectIllegalMove(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//5 21
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//4 22
//                ['W', 'W', 'W', 'W' , 'W', 'W', 'W', 'W', 'W' ,'W' ,'W', 'W','','',''],//3 23
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//2 24
//                ['B', 'B', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//end game board //1 25
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']],//opponent exits the board 27)
//            [20,20,23],[21,22,27],[1,2])
//    });
//
//
...
//    });
//
//    it("black trying to exit the board but not all on home board is illegal", function(){
//       expectIllegalMove(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//           ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//           ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//           ['B', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//    });
//
//    it("trying to exit the board without any moves remaining", function(){
//        expectIllegalMove(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['B', 'B', 'B', 'B' , 'B', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['B', 'B', 'B', 'B' , 'B', 'B', '', '', '' ,'' ,'', '','','',''],//23  3
...
//     *****************************************************************************************************************/
//
//    it("cannot move to the captured position", function(){
//
...
//
//
//    it("making a move on a new board is legal" , function(){
//
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']],//opponent exits the board 27)
//            [2],[5],[1,2])).toEqual([{setTurn: {turnIndex: 1}},
...
//            {set: {key: 'toDelta', value: {toDelta: [5]}}},
//            {set: {key: 'dice', value: {dice: [1,2]}}}])
//    });
//
//    it("making a move before board is initialized is legal" , function(){
//
//        expect(_gameLogic.createMove(0,'',//opponent exits the board 27)
//            [2],[5],[1,2])).toEqual([{setTurn: {turnIndex: 1}},
//            {set: {key: 'board', value: [['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("getting an undefined turn index fails" , function(){
//
//        expectError(undefined,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//22  4
...
//
//
//    it("cannot move into position held by opposing player" , function(){
//
//        expectError(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("getting a null turn index fails" , function(){
//
//        expectError(null,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//22  4
...
//    });
//
//    it("check that not moving into the captured position" , function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check that the roll has been fully used" , function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//
//
//    it("check captured pieces entered the board before any other moves BLACK" , function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check captured pieces entered the board before any other moves WHITE" , function(){
//
//        expectError(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check intermediate points not held by opposing player WHITE" , function(){
//
//        expectError(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check intermediate points not held by opposing player BLACK" , function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check intermediate points not held by opposing player when rolling doubles BLACK" , function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//    });
//
//    it("check intermediate points not held by opposing player when rolling doubles WHITE" , function(){
//
//        expectError(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//
//
//    it("check state rolling doubles", function(){
//
//        expect(_gameLogic.createMove(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']],//opponent exits the board 27)
//            [2],[6],[1,1])).toEqual([{setTurn: {turnIndex: 1}},
//            {set: {key: 'board', value: [['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']]}},
//            {set: {key: 'fromDelta', value: {fromDelta: [2]}}},
//            {set: {key: 'toDelta', value: {toDelta: [6]}}},
//            {set: {key: 'dice', value: {dice: [1,1]}}}])
//    });
//
//
//
...
//    });
//
//    it("trying to exit without any more moves left", function(){
//
//        expectError(1,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//4 22
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//3 23
//            ['W', 'W', 'W', 'W' , 'W', 'W', 'W', 'W', 'W' ,'W' ,'W', 'W','W','W','W'],//2 24
//            ['B', 'B', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//end game board //1 25
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//            ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']], [24,24,24], [27,27,27], [5,6])
//
//    });
//
//
//    it("capture an opposing player", function(){
//
//        expect(_gameLogic.createMove(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', 'W', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']],//opponent exits the board 27)
//            [2],[6],[1,3])).toEqual([{setTurn: {turnIndex: 1}},
//            {set: {key: 'board', value: [['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']],//opponent exits the board 27)
//            [2,2],[3,5],[1,3])).toEqual([{setTurn: {turnIndex: 1}},
//            {set: {key: 'board', value: [['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['W', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','','']]}},
//            {set: {key: 'fromDelta', value: {fromDelta: [2,2]}}},
//            {set: {key: 'toDelta', value: {toDelta: [3,5]}}},
//            {set: {key: 'dice', value: {dice: [1,3]}}}])
//    });
//
//    it("intermediate spot is blocked when moving one piece, move Not Allowed White", function(){
...
//
//
//    it("test end of game functionality white win" ,function(){
//
//        expect(_gameLogic.createMove(0,[['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
...
//                ['B', 'B', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//end game board //1 25
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['W', 'W', 'W', 'W' , 'W', 'W', 'W', 'W', 'W' ,'W' ,'W', 'W','W','W','']],//opponent exits the board 27)
//            [23],[27],[3,2])).toEqual([{endMatch: {endMatchScores: [1,0]}},
//            {set: {key: 'board', value: [['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
...
//            {set: {key: 'fromDelta', value: {fromDelta: [23]}}},
//            {set: {key: 'toDelta', value: {toDelta: [27]}}},
//            {set: {key: 'dice', value: {dice: [3,2]}}}])
//    });
//
//
//
//    it("test end of game functionality black win" ,function(){
//
//        expect(_gameLogic.createMove(1,[['B', 'B', 'B', 'B' , 'B', 'B', 'B', 'B', 'B' ,'B' ,'B', 'B','B','B',''],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['B', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//22  4
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//21  5
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//20  6
...
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken 26
//                ['W', 'W', 'W', 'W' , 'W', 'W', 'W', 'W', 'W' ,'W' ,'W', 'W','W','W','']],//opponent exits the board 27)
//            [2],[0],[3,2])).toEqual([{endMatch: {endMatchScores: [0,1]}},
//            {set: {key: 'board', value: [['B', 'B', 'B', 'B' , 'B', 'B', 'B', 'B', 'B' ,'B' ,'B', 'B','B','B','B'],//opponent exists the board
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//blots taken
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//start game board 24   2
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//23  3
//                ['', '', '', '' , '', '', '', '', '' ,'' ,'', '','','',''],//22  4
...
//
//
//    it("test make move function" ,function(){
//
//        expect(_gameLogic.makeMove(
